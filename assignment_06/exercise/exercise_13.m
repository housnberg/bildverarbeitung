...
a)
    ...
    f�r jedes level
        ...
        Filtergr��e 3*Sigma + 1, fspecial, imfilter (evtl. direkt gauss filter)
...
b)
    ...
    bei keiner �berlappung --> infinity als fehlerwert
    normieren mittels anzahl an pixel, die sich �berlappen
